...
import FormikContact from "@/components/transitions/Forms/FormikContact";
...
export default async function ContactPage({ params: { lang } }) {
  ...
  const dataContentWrapper = {
    ...
    imageSrc: "/images/background/background-contact.webp",
  ...
  return (
    <main>
      <WrapperStart className={styles["start"]}>
        ...
        >
          <FormikContact dict={dataContentForm} lang={lang} trl_error={trl_error} />
        </WrapperFormWithContent>
      </WrapperStart>
    </main>
  );
