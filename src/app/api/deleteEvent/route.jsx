...
import { connectDatabaseEvents, connectDbMongo, deleteDocument, findDocument } from "@/lib/mongodb";
...
export const DELETE = async (request) => {
  ...
  try {
    ...
    client.close();
    return NextResponse.json({ error: notification.trl_generalError + " - 404" }, { status: 404 });
  }
