...
const FormikAccount = dynamic(() => import("../Forms/FormikAccount"));

const NotificationList = dynamic(() => import("../Notification/NotificationList"));
const FormikEvent = dynamic(() => import("../Forms/FormikEvent"));
const ModalDelete = dynamic(() => import("./DeleteModal"));
...
const ModalHandlerServer = ({ lang, trl_err, dict }) => {
  ...
  return (
    <>
      {isVisible && (
        <ModalRoot lang={lang}>
          {isVisible === "settingsModal" && <FormikAccount dict={modalSettings} lang={lang} />}
          {isVisible === "notificationsModal" && <NotificationList lang={lang} />}
