  ...
  return (
    <>
      <header className={classesHeader}>
        ...
        <NavbarDesktop className={styles["header__nav"]} dict={dict} lang={lang} />
        ...
        <ul className={classesListLeagueages}>
          <li
            className={lang === "en" ? classesLangIsActive : styles["header__leanguages-item"]}
            onClick={() => changeLanguageHandler("en")}
          >
            EN
          </li>
          <li
            className={lang === "pl" ? classesLangIsActive : styles["header__leanguages-item"]}
      ...
      {isLoading && (
        <span className={`${styles["header__loading"]} ${styles["rotating-border"]}`}></span>
      )}
    </>
  );
};
